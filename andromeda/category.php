	...
	<?php if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
				...
				<div class="meta">
					by <?php the_author_posts_link(); ?> in <strong><?php the_category(', ') ?></strong>
				</div>

				<div class="entry">
					<?php the_excerpt(','); ?>
					<p><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>">Read more from this topic...</a></p>
